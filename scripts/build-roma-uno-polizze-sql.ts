...
writeFileSync(
  ...
  JSON.stringify(
    toCreate.map((r) => ({
      ...
      riga: r.riga,
      cliente_anagrafica_id: r.clienteId,
      compagnia_id: r.compagniaId,
      ramo_id: r.ramoId,
      anagrafica_commerciale_id: r.produttoreId,
      garanzia_da: r.garanziaDa,
      garanzia_a: r.garanziaA,
      durata_da: r.durataDa,
      durata_a: r.durataA,
      data_scadenza: r.dataScadenza,
      data_competenza: r.dataCompetenza,
      premio_lordo: r.premioLordo,
      provvigioni: r.provvigioni,
      frazionamento: r.frazionamento,
      rate: r.rate,
      percentuale_riparto: r.percentualeRiparto,
      tacito_rinnovo: r.tacitoRinnovo,
      riforma_alla_scadenza: r.riformaAllaScadenza,
      sostituisce_polizza: r.sostituiscePolizza,
      sostituisce_riga: r.sostituisceRiga,
      note: r.note,
      prodotto_nome: r.prodottoNome,
      produttore_nome: r.produttoreNome,
      ae_nome: r.aeNome,
      specialist: r.specialist,
      id_legacy: r.idLegacy,
    })),
  ),
);
