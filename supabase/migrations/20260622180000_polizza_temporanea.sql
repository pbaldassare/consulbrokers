-- Polizza temporanea: 1 quietanza, nessun frazionamento/rinnovo automatico.
ALTER TABLE public.titoli
  ADD COLUMN IF NOT EXISTS polizza_temporanea boolean NOT NULL DEFAULT false;

COMMENT ON COLUMN public.titoli.polizza_temporanea IS
  'Polizza a copertura limitata: genera una sola quietanza, senza frazionamento né rate successive.';
