-- Carico/Incassi filtra i pendenti con tipo_pagamento = 'garantito'
-- (PENDENTI_OR_GARANTITO_APERTO_FILTER) ma la vista non esponeva la colonna.
...
COMMENT ON VIEW public.v_portafoglio_quietanze IS
  'Vista Incassi/portafoglio: include tipo_pagamento per filtro pendenti/garantito.';
