-- annulla_polizza_cascade: elimina anche movimenti_polizze (ricongiungimento bancario)
-- prima di cancellare le quietanze discendenti, altrimenti FK movimenti_polizze_titolo_id_fkey.
