  ...
  try {
    ...
    for (const [key, rows] of Object.entries(grouped)) {
      ...
      const titolo = {
        ...
        cambio: baseRow.cambio ?? 1,
        premio_lordo: stateRow.premio ?? null,
        premio_netto: stateRow.imponibile ?? null,
        tasse: stateRow.tasse_val ?? null,
        provvigioni_firma: baseRow.attive ?? null,
        provvigioni_quietanza: stateRow.passive ?? null,
        data_competenza: stateRow.dt_copertura || null,
        data_incasso: stateRow.dt_incasso || null,
        rate: stateRow.rate ?? null,
        tipo_rinnovo: stateRow.rinnovo || null,
        disdetta_mesi: stateRow.mesi_disd ?? null,
      ...
      const movimenti = rows.map((r: any) => ({
        ...
        premio_netto: r.imponibile ?? null,
        tasse: r.tasse_val ?? null,
        provvigioni_attive: r.attive ?? null,
        provvigioni_passive: r.passive ?? null,
