...
const tabConfig: { value: string; label: string; tableName: string; queryKey: string; title: string; custom?: string | boolean }[] = [
  ...
  { value: "lookup_conti_incasso", label: "Causali Cassa/Banca", tableName: "lookup_conti_incasso", queryKey: "lookup-conti-incasso", title: "Causale Cassa/Banca", description: "Causali contabili per movimenti di cassa e banca (es. Incasso premio, Pagamento provvigioni). Non contiene IBAN — per le coordinate bancarie usa Archivi → Conti Bancari." },
];
