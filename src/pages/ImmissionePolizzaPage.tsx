    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <fieldset className="border border-border rounded-lg p-5 space-y-4">
        ...
        <div className="flex items-end gap-3">
          <div className="space-y-1.5 flex-1 max-w-[200px]">
            <Label htmlFor="codice-cliente">Codice</Label>
      ...
      <fieldset className="border border-border rounded-lg p-5 space-y-4">
        ...
        <div className="flex items-end gap-4 flex-wrap">
          ...
          <div className="space-y-1.5 w-[80px]">
            <Label htmlFor="appendice">Appendice</Label>
            <Input
              id="appendice"
              value={appendice}
      ...
      <fieldset className="border border-border rounded-lg p-5 space-y-4">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center gap-2">
              <RadioGroupItem value="polizza" id="tipo-polizza" />
              <Label htmlFor="tipo-polizza" className="font-normal cursor-pointer">Polizza</Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="emittenda" id="tipo-emittenda" />
              <Label htmlFor="tipo-emittenda" className="font-normal cursor-pointer">Emittenda</Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="cp_nuova" id="tipo-cp-nuova" />
              <Label htmlFor="tipo-cp-nuova" className="font-normal cursor-pointer">CP (Nuova)</Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem value="cp_sost_rinn" id="tipo-cp-sost" />
              <Label htmlFor="tipo-cp-sost" className="font-normal cursor-pointer">CP (Sost/Rinn)</Label>
            </div>
          </RadioGroup>
        </div>
        ...
        <div className="flex items-center gap-2 pt-1">
          ...
          />
          <Label htmlFor="polizza-auto" className="font-normal cursor-pointer">
            Polizza Auto
          </Label>
        </div>
      </fieldset>
