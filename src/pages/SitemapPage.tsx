...
const sezioni = [
  {
    ...
    pagine: [
      { nome: "Dashboard", desc: "Pannello principale con KPI, grafici e feed attività in tempo reale, profilato per ruolo", ruoli: ["admin", "cfo", "ufficio", "contabilita", "produttore", "backoffice"] },
    ],
  },
  {
    area: "Archivi",
    icon: FolderOpen,
    pagine: [
      { nome: "Clienti", desc: "Lista unificata di tutti i clienti (privati, aziende, enti) con ricerca avanzata multi-campo", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
      { nome: "Dettaglio Cliente", desc: "Scheda completa del cliente con dati anagrafici, polizze, sinistri, documenti e timeline", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
  ...
  },
  {
    ...
    icon: ClipboardList,
    pagine: [
      { nome: "Lista Prospect", desc: "Elenco contatti potenziali non ancora clienti, con stato e assegnazione", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
      { nome: "Dettaglio Prospect", desc: "Scheda del prospect con storico contatti e conversione a cliente", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
      { nome: "Trattative", desc: "Pipeline commerciale con preventivi, stato negoziazione e conversione", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
    ],
  },
  {
    area: "Portafoglio",
    icon: FileText,
    pagine: [
      { nome: "Lista Portafoglio", desc: "Vista complessiva di tutte le polizze attive, scadute e in lavorazione", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
      { nome: "Dettaglio Portafoglio", desc: "Scheda polizza con garanzie, premi, movimenti e documenti allegati", ruoli: ["admin", "ufficio", "produttore", "backoffice"] },
  ...
  },
  {
    ...
    pagine: [
      ...
      { nome: "Provvigioni Sede", desc: "Gestione provvigioni per sede con dettaglio per compagnia e ramo", ruoli: ["admin", "ufficio"] },
      ...
      { nome: "Notifiche", desc: "Centro notifiche con avvisi di sistema, scadenze e comunicazioni", ruoli: ["admin", "ufficio", "contabilita", "produttore", "backoffice"] },
      ...
      { nome: "Chat Interna", desc: "Messaggistica interna tra operatori con canali tematici", ruoli: ["admin", "ufficio", "contabilita", "produttore", "backoffice"] },
    ],
  },
  {
