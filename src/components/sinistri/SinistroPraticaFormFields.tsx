  ...
  return (
    <div className="space-y-4">
      ...
      {showNoteImportanti ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="descrizione">Descrizione Accadimento (min {DESCRIZIONE_ACCADIMENTO_MIN} caratteri) *</Label>
            <Textarea
              id="descrizione"
            ...
            <p className="text-[10px] text-muted-foreground text-right">
              {(watch("descrizione") || "").length}/{DESCRIZIONE_ACCADIMENTO_MIN} caratteri minimi
            </p>
