  ...
  // PORTAFOGLIO
  {
    ...
    group: {
      ...
      children: [
        ...
        { label: "Immissione", path: "/portafoglio/immissione", icon: FilePlus },
        { label: "Appendici", path: "/portafoglio/appendici", icon: FileText },
        { label: "Duplicazione", path: "/portafoglio/duplicazione", icon: FileStack },
        { label: "Conferma Emittende", path: "/portafoglio/conferma-emittende", icon: FileCheck },
        { label: "Rinnovi", path: "/portafoglio/rinnovi", icon: CalendarCheck },
        { label: "Storno", path: "/portafoglio/storno", icon: ArrowRightLeft },
        { label: "Diff. Provvigionali", path: "/portafoglio/diff-provvigionali", icon: DollarSign },
        { label: "Sospensione", path: "/portafoglio/sospensione", icon: Clock },
        { label: "Riattivazione", path: "/portafoglio/riattivazione", icon: CheckSquare },
        { label: "Doc. Precontrattuale", path: "/portafoglio/doc-precontrattuale", icon: ClipboardList },
