  ...
  },
  {
    ...
    group: {
      ...
      children: [
        ...
        { label: "E/C Produttori", path: "/contabilita/ec-produttori", icon: Percent },
        { label: "Storico E/C Produttori", path: "/contabilita/ec-produttore/storico", icon: Archive },
        { label: "Caricamento Mov. Bancari", path: "/contabilita/caricamento-mov-bancari?tab=importazione", icon: Import, hideForRoles: ["ufficio","backoffice","contabilita","manager","produttore","corrispondente","cliente","prospect"] },
      ],
    },
  },
  {
